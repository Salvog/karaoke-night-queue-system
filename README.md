...
- Create/edit event nights with venue, date/time, break seconds, cooldown minutes, optional PIN, and status (draft/active/closed).
...
- Song requests enforce per-participant cooldown via `event_nights.request_cooldown_seconds` (stored in minutes).
