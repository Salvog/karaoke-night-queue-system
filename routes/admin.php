...
Route::middleware(['admin.auth', 'admin.role'])->group(function () {
    ...
    Route::get('/venues', [AdminVenuesController::class, 'index'])->name('admin.venues.index');
    Route::post('/venues', [AdminVenuesController::class, 'store'])->name('admin.venues.store');
    Route::put('/venues/{venue}', [AdminVenuesController::class, 'update'])->name('admin.venues.update');
    ...
    Route::post('/events/{eventNight}/queue/pause', [AdminQueueController::class, 'pause'])->name('admin.queue.pause');
    ...
    Route::post('/events/{eventNight}/queue/manual', [AdminQueueController::class, 'storeManual'])->name('admin.queue.manual');
