...
<div style="margin-bottom: 16px;">
    ...
    <input id="code" type="text" name="code" maxlength="12" value="{{ old('code', $eventNight->code ?? '') }}" required>
    <small class="help">Short code shared with guests to join the event.</small>
</div>
...
<div style="margin-bottom: 16px;">
    ...
    <small class="help">Extra seconds added after each song before the next one starts.</small>
</div>
...
<div style="margin-bottom: 16px;">
    ...
    <small class="help">Minimum wait time before the same guest can request another song.</small>
</div>
