@php
    $defaultStart = now()->setTime(19, 0);
    $defaultEnd = now()->addDay()->setTime(2, 0);
    ...
    $requestCooldownMinutes = old(
        'request_cooldown_minutes',
        $eventNight ? (int) ceil(($eventNight->request_cooldown_seconds ?? 0) / 60) : 20
    );
...
<div class="form-grid">
    ...
    <div class="form-field">
        ...
        <input id="code" type="text" name="code" value="{{ $codeValue }}" maxlength="12" readonly placeholder="Generato automaticamente">
        <div class="helper">Il codice viene generato automaticamente al salvataggio.</div>
    </div>
