...
@section('content')
    ...
    @php
        ...
        $backgroundUrl = $eventNight->background_image_path
            ...
            : null;
        $logoUrl = $eventNight->event_logo_path
    ...
    <form method="POST" action="{{ route('admin.theme.update', $eventNight) }}" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 16px;">
            ...
            @if ($logoUrl)
                <div style="margin: 8px 0;">
                    <img src="{{ $logoUrl }}" alt="Anteprima logo" style="max-width: 200px; border-radius: 999px; background: #fff; padding: 8px;">
                </div>
            @endif
                ...
                <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 12px;">
                    <form method="POST" action="{{ route('admin.ad-banners.update', [$eventNight, $ad]) }}" enctype="multipart/form-data">
                        ...
                        <div style="margin-bottom: 8px;">
                            ...
                            <input type="text" name="subtitle" value="{{ $ad->subtitle }}" maxlength="140">
                        </div>
                        <div style="margin-bottom: 8px;">
                        ...
                        @if ($ad->logo_url)
                            <div style="margin-top: 8px;">
                                <img src="{{ $ad->logo_url }}" alt="Logo {{ $ad->title }}" style="max-width: 120px; border-radius: 8px; background: #fff; padding: 8px;">
                            </div>
                        @endif
                        <div style="margin-top: 8px;">
    ...
    <form method="POST" action="{{ route('admin.ad-banners.store', $eventNight) }}" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 8px;">
            <label>Sottotitolo</label>
            <input type="text" name="subtitle" maxlength="140">
        </div>
        <div style="margin-bottom: 8px;">
